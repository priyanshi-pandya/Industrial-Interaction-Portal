    ...
    <div class="row">
      ...
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0  toppad" >
          ...
          <?php 
              $qry1="select * from cmp_tbl where cmp_id='".$_SESSION['id']."'";
                  ...
                  <table class="table table-user-information">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><input type="hidden" name="uid" value="<?php echo $row1['cmp_id'];?>"></td>
                      
                      
                        <td><input type="hidden" name="utype" value="2"></td>
...
<div class="copyright">
  <div class="container">
    <div class="bttxt">Copyright &copy; 2019-20 Your Company Name. All Rights Reserved. Design by: <a href="http://graphicriver.net/user/ecreativesol" target="_blank"></a></div>
  </div>
</div>

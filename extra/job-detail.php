...
<!-- Mirrored from www.sharjeelanjum.com/html/jobs-portal/demo/job-detail.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Nov 2019 09:06:22 GMT -->
<head>
<meta charset="utf-8">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown"><a href="#.">Pages <span class="caret"></span></a> 
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="active"><a href="job-detail.php">Job Detail</a></li>
  ...
  <div class="container"> 
    ...
    <div class="job-header">
      <div class="jobinfo">
        <div class="row">
          <div class="col-md-8">
            <h2>IT Delivery Manager - Epicor ERP</h2>
            <div class="ptext">Date Posted: 2016/05/19</div>
            <div class="salary">Monthly Salary: <strong>$500 - $3000</strong></div>
          </div>
          <div class="col-md-4">
            <div class="companyinfo">
              <div class="companylogo"><img src="images/employers/emplogo1.jpg" alt="your alt text"></div>
          ...
          <div class="jobdetail">
            ...
            <ul class="jbdetail">
              <li class="row">
                ...
                <div class="col-md-6 col-xs-6"><span>Jb132456</span></div>
              </li>
              <li class="row">
              ...
              <li class="row">
                ...
                <div class="col-md-6 col-xs-6"><a href="#.">Themeforest</a></div>
              </li>
              <li class="row">
                <div class="col-md-6 col-xs-6">Type</div>
                <div class="col-md-6 col-xs-6"><span>Private</span></div>
              </li>
              <li class="row">

            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown"><a href="#.">Pages <span class="caret"></span></a> 
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="active"><a href="job-listing.php">Job Listing</a></li>
...
<div class="listpgWraper">
  <div class="container"> 
    ...
    <div class="pageSearch">
      <div class="row">
        <div class="col-md-3"><a href="#." class="btn"><i class="fa fa-file-text" aria-hidden="true"></i> Upload Your Resume</a></div>
        <div class="col-md-9">

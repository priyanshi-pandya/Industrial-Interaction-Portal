<?php
  ...
  $qry1="SELECT * FROM alumni WHERE isactive=0 && cmp_id=$id";
        ...
        <div class="myads">
          ...
          <ul class="searchList">
            ...
            if(mysqli_num_rows($rs1)>0)
            {
              ...
              {
                $cgid=$row1['clg_id'];  
                $qry2="SELECT * FROM clg_tbl WHERE isactive=1 && clg_id=$cgid";
            ...
            <div class="row">
              <div class="col-md-8 col-sm-8">
                <div class="jobinfo">
                  <h3><a href="#"><?php echo $row2['clg_name']; ?></a></h3>
                  <div class=""><a href="#."></a></div>
                </div>
              </div>
              <div class="col-md-4 col-sm-4">
              <form action="approve-req.php" method="post">
                <input type="hidden" name="id" value="<?php echo $row1['id'];?>">
                  <input class="form-control" type="submit" value="Approve" name="btn_app">
                </div>
              </form>
              </div>
            <p style="font-weight: bold; font-size: 16px">Message:</p><?php echo $row1['message']; ?>
          </li>
            <!-- end --> 
            <?php
                    }

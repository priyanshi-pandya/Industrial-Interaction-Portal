...
//var_dump($_GET);
$id=$_GET['id'];
$qry="SELECT * FROM cmp_tbl WHERE cmp_id=$id";
...
<body>
    ...
    <div id="content">
        <div class="outer-w3-agile mt-1 col-12">
                    <h4 class="tittle-w3-agileits mb-4">EDIT COMPANY</h4>

					<form action="updatecmpdata.php" method="get" class="form-inline">
							<input type="hidden" name="id" value="<?php echo $row['cmp_id']; ?>">
							<label 
                        class="col-md-2 col-form-label" for="inlineFormInputName2">Company Name:</label>
						<input type="text" class="form-control mb-2 mr-sm-4" id="inlineFormInputName2" name="txt_fn" value="<?php echo $row['cmp_name']; ?>"><br>
						<label 

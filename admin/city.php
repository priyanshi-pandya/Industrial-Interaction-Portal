...
<body>
    ...
    <div id="content">
        <div class="outer-w3-agile mt-1 col-12">
                    <h4 class="tittle-w3-agileits mb-4">ADD CITY</h4>
                    <form action="addcity.php" method="get" class="form-inline">
                    	<label 
                        ...
                        <label 
                        class="col-sm-2 col-form-label" for="inlineFormInputName2">City Name:</label>
                        <input type="text" class="form-control mb-2 mr-sm-4" id="inlineFormInputName2" name="txt_city" required="">

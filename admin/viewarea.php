...
$qry="SELECT * FROM area_tbl WHERE isactive=1";
	...
	<div class="wrapper">
        ...
        <div id="content">
			...
			<div class="outer-w3-agile mt-3">
                <h4 class="tittle-w3-agileits mb-4">Areas</h4>
					<table class="table">
						...
						if(mysqli_num_rows($rs)>0)
						{
							...
							{
								$sid=$row['sid'];
								$qry1="SELECT * FROM state_tbl WHERE id=$sid AND isactive=1";
								$rs1=mysqli_query($conn,$qry1);
                                $cid=$row['cid'];
                                $qry2="SELECT * FROM city_tbl WHERE id=$cid AND isactive=1";

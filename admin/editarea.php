...
<div class="wrapper">
    ...
    <div id="content">
        <div class="outer-w3-agile mt-1 col-12">
                    <h4 class="tittle-w3-agileits mb-4">EDIT STATE</h4>
					<form action="updatearea.php" method="get" class="form-inline">
						<input type="hidden" name="aid" value="<?php echo $row['id'];?>">
						<label 
                        class="col-md-2 col-form-label" for="inlineFormInputName2">State Name:</label>
                        <input type="text" class="form-control mb-2 mr-sm-4" id="inlineFormInputName2" name="areaname" value="<?php echo $row['areaname'];?>">

    ...
    <div class="row">
      ...
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0  toppad" >
          ...
          <?php 
            $qry1="SELECT * FROM clg_tbl WHERE clg_id='".$_SESSION['id']."'";
                ...
                <div class=" col-md-9 col-lg-9 "> 
                  <table class="table table-user-information">
                    <tbody>
                      <tr>
                        <td>Name:</td>
                        <td><input type="text" name="name" value="<?php echo $row1['clg_name'];?>"></td>
                      </tr>
                      <tr>
                        <td>Password</td>
                      ...
                      <tr>
                        ...
                        <td><input type="hidden" name="uid" value="<?php echo $row1['clg_id'];?>"></td>
                      
                        <td><input type="hidden" name="utype" value="3"></td>
